...
/// <summary>
/// Manages all Sniper NPC animations via Animancer.
/// Strukturell ähnlich zum SoldierAnimationManager, aber ohne
/// FiringStance-Loop (Sniper schießt nur einmal pro Zyklus).
///
/// SETUP:
...
public class SniperAnimationManager : MonoBehaviour, INpcAnimationHandler
{
    ...
    /// <summary>
    /// Play fire one-shot (Einzelschuss). Returns to aim hold after.
    /// </summary>
