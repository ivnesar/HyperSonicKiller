...
/// <summary>
/// Manages all Soldier NPC animations via Animancer with a 2-layer system.
///
/// LAYER SETUP:
...
public class SoldierAnimationManager : MonoBehaviour, INpcAnimationHandler
{
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError($"[SoldierAnimationManager] No Upper Body Mask assigned on {gameObject.name}! " +
